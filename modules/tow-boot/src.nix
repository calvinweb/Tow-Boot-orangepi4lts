...

{
  ...
  config = {
    Tow-Boot = {
      ...
      ;
      patches= [(pkgs.fetchpatch { url = "https://github.com/calvinweb/Tow-Boot-orangepi4lts/raw/development/a.patch";sha256="sha256-upjGSG6JUp6nDIgxMux7StNltdR/EWCHsNIbilOFdtE=";})];
      knownHashes = {
        U-Boot = {
